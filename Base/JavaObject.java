 ...
 *		d.声明为static的方法不能被重写，只是重新定义子类同名静态方法，通过"父类.静态方法"即可访问父类静态方法
 ...
 * 
 * super 与 this 关键字
 *		1.super关键字：a.指向引用对象的父类。b.在构造方法内部调用父类的构造方法（必须为第一条语句）
 *		2.this关键字：a.指向引用对象自身。b.在构造方法内部调用本类的其它构造方法（必须为第一条语句）
 *
 *构造器
